            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    ...
                    <div class="pull-right" data-html2canvas-ignore="true">
                        ...
                        @if(( $appInfo->is_ccie_submitted_irc_1st == 1 && (Auth::user()->user_type == '5x505' && in_array($appInfo->status_id,[25])) || in_array(Auth::user()->user_type, ['1x101','2x202', '4x404']) ) || ( $appInfo->is_ccie_submitted_irc_1st == 0 && in_array(Auth::user()->user_type, ['1x101','2x202']) ))

                            @if(count($inspectionInfo) > 0 && !empty($last_inspection_id))
                                ...
                                @if((Auth::user()->user_type == '5x505' && in_array($appInfo->status_id,[25])) || in_array(Auth::user()->user_type, ['1x101','2x202', '4x404']))
                                    ...
                                    @if($appInfo->irc_purpose_id != 2)
                                        <a href="{{ url('irc-recommendation-new/production-capacity-pdf/'.Encryption::encodeId($appInfo->id)) }}" class="btn btn-sm btn-primary" title="" target="_blank">Production Capacity</a>
                                    @endif

                                    <a href="{{ url('irc-recommendation-new/existing-machines-pdf/'.Encryption::encodeId($appInfo->id)) }}" class="btn btn-sm btn-primary" title="" target="_blank">Existing Machinery</a>

                                    @if($appInfo->irc_purpose_id != 2)
                                        <a href="{{ url('irc-recommendation-new/entitlement-paper-pdf/'.Encryption::encodeId($last_inspection_id)) }}" class="btn btn-sm btn-primary" title="" target="_blank">Entitlement Paper</a>
                                    @endif
                ...
                <div class="panel-body">
                    @if (in_array($appInfo->status_id,[25]) && $appInfo->is_ccie_submitted_irc_1st == 0)
                        <div class="p-5">
                            <div class="alert alert-warning" role="alert">
                                <h4 class="alert-heading">
                                    <i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Warning!
                                    @if(in_array(Auth::user()->user_type, ['5x505']))
                                        <a href="{{ url('process/licence-applications/ccie/add', \App\Libraries\Encryption::encodeId(113)) }}" class="btn btn-sm btn-primary pull-right" title="" target="_blank">
                                            Apply for CCI&E
                                        </a>
                                    @endif
                                </h4>
                                <p>Please, collect the Industrial IRC (First Adhoc) license of the Chief Controller of Imports & Exports(CCI&E) from the system to get the approval copy.</p>
                            </div>
                        </div>
                    @endif

                    {{--Prevous Applications--}}
                    @include('IrcRecommendationNew::prevous-applications')
                    ...
                    @include('IrcRecommendationNew::inspection-information')
                ...
                <!-- Inspection Submission Deadline Date -->
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-5 col-xs-6">
                                    <span class="v_label">IRC type</span>
                                    <span class="pull-right">&#58;</span>
                                </div>
                                <div class="col-md-7 col-xs-6">
                                    {{ (!empty($appInfo->irc_type_name)) ? $appInfo->irc_type_name :''  }}
                                </div>
                            </div>
                                    ...
                                    @if($appInfo->last_br == 'yes')
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-xs-6">
                                                ...
                                                {!! CommonFunction::getCertificateByTrackingNo($appInfo->ref_app_tracking_no) !!}
                                            </div>
                                        </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                                                ...
                                                <div class="col-md-12">
                                                    <table class="table table-striped table-bordered" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Quantity</td>
                                                            <td>Price (USD)</td>
                                                            <td>Sales Value in BDT (million)</td>
                                                            <td>Raw Materials Details</td>
                                                        </tr>
                                                        </thead>
                                                        <?php $inc = 0; ?>
                                                        @foreach($annualProductionCapacity as $rawMaterial)
                                                            <tr>
                                                                <td>{{ ($rawMaterial->product_name ? $rawMaterial->product_name : '') }}</td>
                                                                <td>{{ ($rawMaterial->name ? $rawMaterial->name : '') }}</td>
                                                                <td>{{ ($rawMaterial->quantity ? $rawMaterial->quantity : '') }}</td>
                                                                <td>{{ ($rawMaterial->price_usd ? $rawMaterial->price_usd : '') }}</td>
                                                                <td>{{ ($rawMaterial->price_taka ? $rawMaterial->price_taka : '') }}</td>
                                                                <td>
                                                                    <a data-toggle="modal" data-target="#IRCModal" onclick="openModal(this)" data-action="{{ url('irc-recommendation-new/get-raw-material/'.Encryption::encodeId($rawMaterial->apc_id)) }}" class="btn btn-xs btn-success"><i class="fa fa-folder-open"></i> Raw Material</a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </table>
                                                    ...
                                                    <table class="table table-striped table-bordered" cellspacing="0"
                                                        ...
                                                        @foreach($annualProductionSpareParts as $eachProductionSpare)
                                                            <tr>
                                                                ...
                                                                <td>{{ ($eachProductionSpare->name ? $eachProductionSpare->name : '') }}</td>
                            ...
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">9. Public utility service</legend>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">10. Trade licence details</legend>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="col-md-5 col-xs-6">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        @if($appInfo->fire_license_info == 'already_have')
                                            <div class="col-md-12">
                                                <div class="col-md-5 col-xs-6">
                                                    <span>Already have License No.</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="col-md-5 col-xs-6">
                                        ...
                                        @if($appInfo->fire_license_info == 'applied_for')
                                            <div class="col-md-12">
                                                <div class="col-md-5 col-xs-6">
                                                    <span>Applied for License No.</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="col-md-5 col-xs-6">
                                                    <span class="v_label">Application Number</span>
                                                    <span class="pull-right">&#58;</span>
                                                </div>
                                                <div class="col-md-7 col-xs-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-5 col-xs-6">
                                                    <span class="v_label">Apply Date</span>
                                                    <span class="pull-right">&#58;</span>
                                                </div>
                                                <div class="col-md-7 col-xs-6">
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-md-5 col-xs-6">
                                                <span class="v_label">Bank address</span>
                                                <span class="pull-right">&#58;</span>
                                            </div>
                                            <div class="col-md-7 col-xs-6">
                            ...
                            {{--18. Other Licenses/ NOC/ Permission/ Registration--}}
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">18. Other Licenses/ NOC/ Permission/ Registration</legend>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table class="table table-striped table-bordered" cellspacing="0"
                                                ...
                                                @if(count($otherLicence)>0)
                                                    <?php $inc = 1; ?>
                                                    @foreach($otherLicence as $otherValue)
                                                        <tr>
                                                            <td>{{ $inc++ }}</td>
                                                            <td>{{ ($otherValue->licence_name ? $otherValue->licence_name : '') }}</td>
                                                            <td>{{ ($otherValue->licence_no ? $otherValue->licence_no : '') }}</td>
                                                            <td>{{ ($otherValue->issuing_authority ? $otherValue->issuing_authority : '') }}</td>
                                                            <td>{{ (!empty($otherValue->issue_date) ? date('d-M-Y', strtotime($otherValue->issue_date)) : '') }}</td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                            </table>
