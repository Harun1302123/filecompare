                    ...
                    <div class="panel-heading">
                        ...
                        @if(in_array(Auth::user()->user_type, ['1x101','2x202', '4x404']))
                            <div class="pull-right">
                                <a href="{{ url('irc-recommendation-new/report-generate/'.Encryption::encodeId($inspectionInfo->id)) }}" class="btn btn-sm btn-success" title="" target="_blank">Inspection report</a>
                            </div>
                        @endif
                        {{--                            <div class="pull-right">--}}
                        {{--                                <a data-toggle="modal" data-target="#IRCModal" onclick="openModal(this)" data-action="{{ url('irc-recommendation-new/get-inspection-raw-material/'.Encryption::encodeId($inspectionInfo->app_id)) }}" class="btn btn-sm btn-primary">Raw Materials</a>--}}
                        {{--                                <a data-toggle="modal" data-target="#IRCModal" onclick="openModal(this)" data-action="{{ url('irc-recommendation-new/get-existing-machines/'.Encryption::encodeId($inspectionInfo->app_id)) }}" class="btn btn-sm btn-primary">Exisiting Machineries</a>--}}

                        {{--                                --}}{{--  Application user cannot access Generate Report and Entitlement Paper button--}}
                        {{--                                @if(!in_array(Auth::user()->user_type, ['5x505']))--}}
                        {{--                                    <a data-toggle="modal" data-target="#IRCModal" onclick="openModal(this)" data-action="{{ url('irc-recommendation-new/entitlement-paper/'.Encryption::encodeId($inspectionInfo->id)) }}" class="btn btn-sm btn-primary">Entitlement Paper</a>--}}
                        {{--                                    <a href="{{ url('irc-recommendation-new/report-generate/'.Encryption::encodeId($inspectionInfo->id)) }}" class="btn btn-sm btn-success" title="" target="_blank">Inspection report</a>--}}
                        {{--                                @endif--}}
                        {{--                            </div>--}}
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7">
                                                    <span>{{$inspectionInfo->bank_name}}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <div class="col-md-5">
                                                ...
                                                <div class="col-md-7">
                                                    <span>{{$inspectionInfo->branch_name}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                <div class="col-md-5">
                                                    <span class="v_label">ব্যাংকের ঠিকানা</span>
                                                    <span class="pull-right">&#58;</span>
                                                </div>
                                                <div class="col-md-7">
                                                    <span>{{$inspectionInfo->bank_address}}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="col-md-5">
                                ...
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            {{--                                            <div class="col-md-6 form-group">--}}
                                            {{--                                                {!! Form::label('environmental_clearance_copy','আবেদনের কপি :',['class'=>'col-md-5 text-left v_label']) !!}--}}
                                            {{--                                                <div class="col-md-7">--}}
                                            {{--                                                    @if(!empty($inspectionInfo->environmental_clearance_copy))--}}
                                            {{--                                                        <a target="_blank" class="documentUrl btn btn-xs btn-primary"--}}
                                            {{--                                                           href="{{URL::to('/uploads/'.(!empty($inspectionInfo->environmental_clearance_copy) ? $inspectionInfo->environmental_clearance_copy : ''))}}">--}}
                                ...
                                {{--                                <fieldset class="scheduler-border">--}}
                                {{--                                    <legend class="scheduler-border">(জ) পেমেন্ট সম্পর্কিত তথ্য</legend>--}}
                                {{--                                    <div class="row">--}}
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <div class="col-md-6">--}}
                                {{--                                                {!! Form::label('depositor_name','জমাদানকারীর নাম :',['class'=>'text-left col-md-5 v_label']) !!}--}}
                                {{--                                                <div class="col-md-7">--}}
                                {{--                                                </div>--}}
                                {{--                                            </div>--}}
                                {{--                                            <div class="col-md-6 form-group">--}}
                                {{--                                                {!! Form::label('depositor_email','জমাদানকারীর ইমেইল :',['class'=>'col-md-5 text-left v_label']) !!}--}}
                                {{--                                                <div class="col-md-7">--}}
                                {{--                                                </div>--}}
                                {{--                                            </div>--}}
                                {{--                                        </div>--}}
                                ...
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <div class="col-md-6">--}}
                                {{--                                                {!! Form::label('depositor_phone_no','জমাদানকারীর ফোন নম্বর :',['class'=>'text-left col-md-6 v_label']) !!}--}}
                                {{--                                                <div class="col-md-6">--}}
                                {{--                                                </div>--}}
                                {{--                                            </div>--}}
                                {{--                                            <div class="col-md-6 form-group">--}}
                                {{--                                                {!! Form::label('depositor_address','জমাদানকারীর ঠিকানা :',['class'=>'col-md-5 text-left v_label']) !!}--}}
                                {{--                                                <div class="col-md-7">--}}
                                ...
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <div class="col-md-6">--}}
                                {{--                                                {!! Form::label('scroll_number','স্ক্রল নম্বর :',['class'=>'text-left col-md-5 v_label']) !!}--}}
                                {{--                                                <div class="col-md-7">--}}

                                {{--                                                </div>--}}
                                {{--                                            </div>--}}
                                {{--                                            <div class="col-md-6 form-group">--}}
                                {{--                                                {!! Form::label('chalan_copy','চালান কপি :',['class'=>'col-md-5 text-left v_label']) !!}--}}
                                {{--                                                <div class="col-md-7">--}}
                                ...
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <div class="col-md-6">--}}
                                {{--                                                {!! Form::label('chalan_amount','অর্থের পরিমান :',['class'=>'text-left col-md-5 v_label']) !!}--}}
                                {{--                                                <div class="col-md-7">--}}
                                {{--                                                </div>--}}
                                {{--                                            </div>--}}
                                {{--                                            <div class="col-md-6 form-group">--}}
                                {{--                                                {!! Form::label('chalan_vat_tax','ভ্যাট/ ট্যাক্স :',['class'=>'col-md-5 text-left v_label']) !!}--}}
                                {{--                                                <div class="col-md-7">--}}
                                {{--                                                </div>--}}
                                {{--                                            </div>--}}
                                {{--                                        </div>--}}
                                ...
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <div class="col-md-6">--}}
                                {{--                                                {!! Form::label('bank_charge','ব্যাংক চার্জ :',['class'=>'text-left col-md-5 v_label']) !!}--}}
                                {{--                                                <div class="col-md-7">--}}

                                {{--                                                </div>--}}
                                {{--                                            </div>--}}
                                {{--                                            <div class="col-md-6 form-group">--}}
                                {{--                                                {!! Form::label('total_amount','মোট অর্থের পরিমান :',['class'=>'col-md-5 text-left v_label']) !!}--}}
                                {{--                                                <div class="col-md-7">--}}
                                ...
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <div class="col-md-6">--}}
                                {{--                                                {!! Form::label('bank_charge','পেমেন্ট স্টেটাস :',['class'=>'text-left col-md-5 v_label']) !!}--}}
                                {{--                                                <div class="col-md-7">--}}
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" cellspacing="0" width="100%">
                                        <tbody id="manpower">
                                        <tr>
                                            <th colspan="3">বাংলাদেশী</th>
                                            <th colspan="3">বিদেশী</th>
                                            <th colspan="1">সর্বমোট</th>
                                        ...
                                        @foreach($annualProductionCapacity as $apc)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{ (!empty($apc->quantity) ? $apc->quantity : '') }}
                                                </td>
                                                <td>
                                ...
                                @if($inspectionInfo->irc_purpose_id != 2 && count($inspectionAnnualProductionCapacity) > 0)
                                    ...
                                    <table class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{-- <span>{{ $inspectionInfo->apc_half_yearly_import_other ?? 0 }}</span> --}}
                                                <span>{{ empty($inspectionInfo->apc_half_yearly_import_other) ? 0 : $inspectionInfo->apc_half_yearly_import_other }}</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span>
                                                	{{ floatval(isset($inspectionInfo->apc_half_yearly_import_total) ? $inspectionInfo->apc_half_yearly_import_total : 0) + floatval(isset($inspectionInfo->apc_half_yearly_import_other) ? $inspectionInfo->apc_half_yearly_import_other : 0) }}
                                                </span>
                                            </td>
                                        </tr>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group" style="margin-top: 2px">
                                            <div class="col-md-2">
                                                <span>{{ $inspectionInfo->em_lc_total_percent }}</span>
                                            </div>
                                            <div class="col-md-4">
                                                {!! Form::label('em_lc_total_five_percent','% হারে অর্থাৎ',['class'=>'text-left col-md-4 v_label']) !!}
                                                <div class="col-md-8">
                                                    <span>{{ $inspectionInfo->em_lc_total_five_percent }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                {!! Form::label('em_lc_total_five_percent_in_word','কথায়',['class'=>'col-md-2 text-left v_label']) !!}
                                                <div class="col-md-10">
                                                    <span>{{ $inspectionInfo->em_lc_total_five_percent_in_word }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered table-responsive">
                                    ...
                                    <tr>
                                        <td width="25%">
                                            ...
                                            {{ $inspectionInfo->factory_address }}
                                        </td>
                                        <td width="20%"><span>{{$inspectionInfo->entitlement_remarks}}</span></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
