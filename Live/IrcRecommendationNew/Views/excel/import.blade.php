...
{!! Form::open(array('url' => '/irc-recommendation-new/upload-csv-file','method' => 'post', 'class' => 'form-horizontal', 'id' => 'batchUpload',
...
<div class="modal-body">
    <div class="row form-group" id="unit_of_product">
        <div class="col-md-6 {{$errors->has('unit_of_product') ? 'has-error': ''}}">
            ...
            <div class="col-md-8">
                {!! Form::select('unit_of_product', [1=>'1', 10=>'10', 100=>'100', 1000=>'1000'], '', ["id" => 'unit_of_product_id', "placeholder" => "Select One", 'class' => 'form-control input-md required']) !!}
