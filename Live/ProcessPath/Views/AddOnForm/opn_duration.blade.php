        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-3 {{$errors->has('approved_desired_duration') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-12">
                        {!! Form::text('approved_desired_duration', $opn_info->approved_desired_duration, ['class' => 'form-control input-md']) !!}
                ...
                <div class="col-md-3 {{$errors->has('approved_duration_amount') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-12">
                        {!! Form::text('approved_duration_amount', $opn_info->approved_duration_amount, ['class' => 'form-control input-md']) !!}
