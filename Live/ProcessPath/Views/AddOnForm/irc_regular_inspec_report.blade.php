                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="row">
                                        {!! Form::label('inspection_report_date','পরিদর্শনের তারিখ', ['class'=>'col-md-5']) !!}
                                        <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 {{$errors->has('registering_authority_memo_no') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-8">
                                                {!! Form::text('registering_authority_memo_no', $appInfo->registering_authority_memo_no, ['class'=>'form-control input-md', 'id'=>"registering_authority_memo_no"]) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('reg_no') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-8">
                                                {!! Form::text('reg_no', $appInfo->reg_no, ['class'=>'form-control input-md', 'id'=>"number_of_registration"]) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('date_of_registration') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-8">
                                                <div class="datepicker input-group date" data-date-format="dd-mm-yyyy">
                                                    {!! Form::text('date_of_registration', (empty($appInfo->date_of_registration) ? '' : date('d-M-Y', strtotime($appInfo->date_of_registration))), ['class'=>'form-control input-md', 'id' => 'date_of_registration', 'placeholder'=>'Pick from datepicker']) !!}
                                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                {!! Form::hidden('chnage_bank_info', $appInfo->chnage_bank_info ,['class' => 'form-control input-md ', 'id'=>'chnage_bank_info']) !!}
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-6 {{$errors->has('n_bank_id') ? 'has-error': ''}}">
                                                {!! Form::label('n_bank_id','ব্যাংকের নাম',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                            ...
                                            <div class="col-md-6 form-group {{$errors->has('n_branch_id') ? 'has-error': ''}}">
                                                {!! Form::label('n_branch_id','ব্যাংক শাখার নাম',['class'=>'col-md-5 text-left ']) !!}
                                                <div class="col-md-7">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-6 {{$errors->has('n_bank_account_number') ? 'has-error': ''}}">
                                                {!! Form::label('n_bank_account_number','হিসাব নম্বর :',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                            ...
                                            <div class="col-md-6 form-group {{$errors->has('n_bank_account_title') ? 'has-error': ''}}">
                                                {!! Form::label('n_bank_account_title','একাউন্ট নাম :',['class'=>'col-md-5 text-left ']) !!}
                                                <div class="col-md-7">
                                ...
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border">(চ) ফায়ার লাইসেন্স নং</legend>
                                ...
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border">(ছ) ইনকর্পোরেশন</legend>
                                    <div class="row">
                                        <div class="form-group">
                                ...
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border">(জ) পরিবেশ ছাড়পত্র</legend>
                            ...
                            <div class="panel-body">
                                @if($appInfo->irc_purpose_id != 2)
                                    ...
                                    <table class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                        <?php $count = 1;?>
                                        @foreach($ircSixMonthsImportRawMaterials as $apc)
                                            <tr>
                                                <td><?php echo $count++ ?></td>
                                                <td>{!! Form::text("product_name[]", $apc->product_name, ['class' => 'form-control input-md', 'readonly']) !!}</td>
                                                <td>{!! Form::number("fixed_production[]", $apc->yearly_production, ['class' => 'form-control input-md required', 'onkeyup' => "calculateHalfYearlyProduction(this)"]) !!}</td>
                                                <td>{!! Form::number("half_yearly_production[]", $apc->half_yearly_production, ['class' => 'form-control input-md required', 'readonly']) !!}</td>
                                                <td>{!! Form::number("half_yearly_import[]", $apc->half_yearly_import, ['class' => 'form-control input-md apc_half_yearly_import required', 'onkeyup' => "calculateHalfYearlyImportTotal('apc_half_yearly_import', 'apc_half_yearly_import_total')"]) !!}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                        <tfoot>
                                        <tr>
                                            ...
                                            <td>{!! Form::number("apc_half_yearly_import_total", $appInfo->n_ins_apc_half_yearly_import_total?$appInfo->n_ins_apc_half_yearly_import_total:$appInfo->ins_apc_half_yearly_import_total , ['class' => 'form-control input-md', 'id' => 'apc_half_yearly_import_total', 'readonly']) !!}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="4"><span class="pull-right">অন্যান্য টাকার পরিমান</span></td>
                                            <td>{!! Form::number("apc_half_yearly_import_other", $appInfo->apc_half_yearly_import_other ? $appInfo->apc_half_yearly_import_other : '0.00', ['class' => 'form-control input-md', 'id' => 'apc_half_yearly_import_other', 'onkeyup' => "calculateGrandTotal()"]) !!}</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12 {{$errors->has('apc_half_yearly_import_total_in_word') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-11">
                                                    {!! Form::text('apc_half_yearly_import_total_in_word', $appInfo->n_ins_apc_half_yearly_import_total_in_word?$appInfo->n_ins_apc_half_yearly_import_total_in_word: $appInfo->ins_apc_half_yearly_import_total_in_word , ['class' => 'form-control input-md required']) !!}
                        ...
                        @if($appInfo->irc_purpose_id != 1)
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-6 {{$errors->has('em_lc_total_taka_mil') ? 'has-error': ''}}">
                                                {!! Form::label('em_lc_total_taka_mil','প্রতিষ্ঠান কর্তৃক এলসিকৃত মূলধনী যন্ত্রপাতির মোট মূল্যের',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('em_lc_total_taka_mil', $appInfo->n_first_em_lc_total_five_percent ? $appInfo->n_first_em_lc_total_five_percent : $appInfo->first_em_lc_total_five_percent, ['class' => 'form-control input-md required']) !!}
                                                    {!! $errors->first('em_lc_total_taka_mil','<span class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 form-group {{$errors->has('em_lc_total_five_percent_in_word') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-10">
                                                    {!! Form::text('em_lc_total_five_percent_in_word', $appInfo->n_first_em_lc_total_five_percent_in_word ? $appInfo->n_first_em_lc_total_five_percent_in_word : $appInfo->first_em_lc_total_five_percent_in_word, ['class' => 'form-control input-md required']) !!}
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">মন্তব্য</div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="form-group">
...
// End of code from bida old -------------
    ...
    $(document).ready(function () {
        calculateHalfYearlyImportTotal('apc_half_yearly_import', 'apc_half_yearly_import_total');
        calculateGrandTotal();
    });
