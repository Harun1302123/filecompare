...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @if($lastInspectionInfo->irc_purpose_id != 2 && count($annualProductionCapacity) > 0)
                <?php $count = 1; ?>
                @foreach($annualProductionCapacity as $apc)
                    ...
                    $raw_material = App\Modules\IrcRecommendationSecondAdhoc\Models\SecondRawMaterial::where('apc_product_id', $apc->id)
            ...
            @if($lastInspectionInfo->irc_purpose_id != 1 && count($inspectionAnnualProductionSpareParts) > 0)
