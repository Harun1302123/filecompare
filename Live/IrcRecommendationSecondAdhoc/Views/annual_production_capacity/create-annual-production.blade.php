{!! Form::open(array('url' => '/irc-recommendation-second-adhoc/store-annual-production','method' => 'post', 'class' => 'form-horizontal smart-form','id'=>'annualProductionForm',
...
<div class="modal-body">
    ...
    <div class="table-responsive">
        <table id="annualProductionTable" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
            <thead>
            <tr>
            ...
            <tr id="annualProductionTableRow" data-number="1" class="table-tr">
                ...
                <td>
                    {!! Form::number("em_price_usd[]", '', ['class' => 'fnumberNoNegative form-control input-md product required']) !!}
                </td>
