...
<script language="javascript">
    ...
    //         window.opener.document.getElementById("BidaRegistrationForm").setAttribute("target", "_self");
    //         window.opener.jQuery("#BidaRegistrationForm").submit();
    //         window.close();
    //     });
    // });
    ...
    jQuery('#BidaRegistrationForm :input').attr('disabled', true);
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#BidaRegistrationForm-p-5").css({"display": "block"});
