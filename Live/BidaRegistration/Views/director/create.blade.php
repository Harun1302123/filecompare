...
{!! Form::open(array('url' => '/bida-registration/store-verify-director', 'method' => 'post', 'class' => 'form-horizontal smart-form', 'id'=>'directorVerifyForm',
...
<div class="modal-footer" style="text-align:left;">
    <div class="table-responsive" style="height: 150px">
        <table id="directorListModal" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th>#</th>
                <th>Name</th>
...
//                            document.getElementById('passport_type').value = obj.data.document_type;
    ...
    {{--$(function () {--}}
    {{--    $.ajax({--}}
    {{--        url: "{{ url("bida-registration/get-modal-listOf-directors") }}",--}}
    {{--        type: "POST",--}}
    {{--        data: {--}}
    {{--            app_id: "{{ $app_id }}",--}}
    {{--            encoded_process_type_id: "{{ $encoded_process_type }}",--}}
    {{--        },--}}
    {{--        cache: false,--}}
