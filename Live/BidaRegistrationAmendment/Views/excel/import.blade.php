...
{!! Form::open(array('url' => '/bida-registration-amendment/excel-file-upload','method' => 'post', 'class' => 'form-horizontal', 'id' => 'batchUpload',
        ...
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div style="text-align: center">
                                <a href="{{ asset('assets/csv-sample/BRA_machinery_sample.xlsx') }}"
                                   ref="noopener" target="_blank">Sample Sheet</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="alert alert-danger" style="font-size:13px;">
                ...
                will be mismatched. To follow the given sample file, you can <a
                        href="{!! url('uploads/csv-upload/sample/BRA_machinery_sample.xlsx') !!}" title="Sample file">
