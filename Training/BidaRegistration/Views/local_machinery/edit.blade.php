    ...
    <div class="col-md-10 col-md-offset-1">
        ...
        <div class="form-group">
            <div class="{{$errors->has('l_machinery_local_qty') ? 'has-error': ''}}">
                ...
                <div class="col-md-8">
                    {!! Form::text('l_machinery_local_qty', $local_machinery->l_machinery_local_qty, ['class' => 'form-control input-md required']) !!}
        ...
        <div class="form-group">
            <div class="{{$errors->has('l_machinery_local_unit_price') ? 'has-error': ''}}">
                ...
                <div class="col-md-8">
                    {!! Form::text('l_machinery_local_unit_price', $local_machinery->l_machinery_local_unit_price, ['class' => 'form-control input-md required']) !!}
        ...
        <div class="form-group">
            <div class="{{$errors->has('l_machinery_local_total_value') ? 'has-error': ''}}">
                ...
                <div class="col-md-8">
                    {!! Form::text('l_machinery_local_total_value', $local_machinery->l_machinery_local_total_value, ['class' => 'form-control input-md required']) !!}
