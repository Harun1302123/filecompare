...
<div class="panel panel-info" id="attachment_review">
                    ...
                    @foreach($document as $row)
                        <tr>
                            ...
                            <td colspan="6">
                                ...
                                @if($viewMode != 'on')
                                    <a class='btn btn-xs btn-primary recent_attachment_btn' data-toggle='modal'
                            ...
                            <td colspan="2">
                                ...
                                @if(!empty($row->doc_file_path))
                                    <div class="save_file saved_file_{{$row->id}}">
                                        ...
                                        <?php if($viewMode != 'on') {?>
                                        <a class="attachment_remove_btn" href="javascript:void(0)" onclick="removeAttachedFile({!! $row->id !!}, {!! $row->doc_priority !!})"><span class="btn btn-xs btn-danger"><i class="fa fa-times"></i></span> </a>
                                        <?php } ?>
                                    </div>
                                @endif
