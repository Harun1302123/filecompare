...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <table class="table table-striped table-bordered display" style="width: 100%">
                        ...
                        <td>{!! $row->doc_name !!}
                            @if($viewMode != 'on')
                                <a class='btn btn-xs btn-primary' data-toggle='modal'
                                   ...
                                   data-action='{{ url('process/recent-attachment/'. \App\Libraries\Encryption::encodeId($row->id)) }}'><i
                                            class='fa fa-file-pdf-o'></i> Recent attachment</a>
                            @endif
                        </td>
                        <td>
                                ...
                                <div class="save_file saved_file_{{$row->id}}">
                                    ...
                                    <a href="javascript:void(0)"
                                       onclick="removeAttachedFile({!! $row->id !!}, {!! $row->doc_priority !!})"><span
                                                class="btn btn-xs btn-danger"><i class="fa fa-times"></i></span>
                                    </a>
                                    <?php } ?>
                                </div>
                            @endif
            ...
            @else
                <tr>
                    <td colspan="3" style="text-align: center"><span class="label label-info">No Required Documents!</span></td>
                </tr>
            @endif
            </tbody>
            <tfoot>
            <tr>
                <td>N.B</td>
                <td>All documents shall have to be attested by the Chairman/ CEO / Managing dirctor/ Country
                    Manager/ Chief executive of the Company/ firms.
                </td>
                <td>Document's must be submitted by an authorized person of the organization including the letter of
                    authorization.
                </td>
            </tr>
            </tfoot>
