{!! Form::open(array('url' => '/bida-registration-amendment/local-machinery-store','method' => 'post', 'class' => 'form-horizontal smart-form','id'=>'localMachineryForm',
        'enctype' =>'multipart/form-data', 'files' => 'true', 'role' => 'form')) !!}

<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
    <h4 class="modal-title" id="myModalLabel"> Add New Local Machinery</h4>
</div>
...
<div class="modal-body">
    ...
    <div class="table-responsive">
        <table id="localMachineryTable" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
            <thead>
            <tr>
            ...
            <tbody>
            <tr id="localMachineryTableRow" data-number="1">
                <td class="light-yellow">
                    {!! Form::text('l_machinery_local_name[]', '', ['class' => 'form-control input-md machinery_imported_name', 'id' => 'l_machinery_local_name0', 'readonly']) !!}
                    {!! $errors->first('l_machinery_local_name','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-yellow">
                    {!! Form::text('l_machinery_local_qty[]', '', ['class' => 'form-control input-md', 'id' => 'l_machinery_local_qty0', 'readonly']) !!}
                    {!! $errors->first('l_machinery_local_qty','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-yellow">
                    {!! Form::text('l_machinery_local_unit_price[]', '', ['class' => 'form-control input-md', 'id' => 'l_machinery_local_unit_price0', 'readonly']) !!}
                    {!! $errors->first('l_machinery_local_unit_price','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-yellow">
                    {!! Form::text('l_machinery_local_total_value[]', '', ['class' => 'form-control input-md', 'id' => 'l_machinery_local_total_value0', 'readonly']) !!}
                    {!! $errors->first('l_machinery_local_total_value','<span class="help-block">:message</span>') !!}
                </td>

                <td class="light-green">
                    {!! Form::text('n_l_machinery_local_name[]', '', ['class' => 'form-control input-md machinery_imported_name', 'id' => 'n_l_machinery_local_name0', 'readonly']) !!}
                    {!! $errors->first('n_l_machinery_local_name','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-green">
                    {!! Form::text('n_l_machinery_local_qty[]', '', ['class' => 'form-control input-md', 'id' => 'n_l_machinery_local_qty0', 'readonly']) !!}
                    {!! $errors->first('n_l_machinery_local_qty','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-green">
                    {!! Form::text('n_l_machinery_local_unit_price[]', '', ['class' => 'form-control input-md', 'id' => 'n_l_machinery_local_unit_price0', 'readonly']) !!}
                    {!! $errors->first('n_l_machinery_local_unit_price','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-green">
                    {!! Form::text('n_l_machinery_local_total_value[]', '', ['class' => 'form-control input-md', 'id' => 'n_l_machinery_local_total_value0', 'readonly']) !!}
                    {!! $errors->first('n_l_machinery_local_total_value','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-green">
                    {!! Form::select("amendment_type[]", $amendment_type, 'add', ['class'=>'form-control input-md local-machinery-action', 'id' => 'amendment_type0', 'style' => 'width:75px;', 'onchange' => 'actionWiseFieldDisable(this, ["l_machinery_local_name0", "l_machinery_local_qty0", "l_machinery_local_unit_price0", "l_machinery_local_total_value0"], ["n_l_machinery_local_name0", "n_l_machinery_local_qty0", "n_l_machinery_local_unit_price0", "n_l_machinery_local_total_value0"])']) !!}
                    {!! $errors->first('action','<span class="help-block">:message</span>') !!}
                </td>

                <td class="light-green" style="text-align: left;">
                    <a class="btn btn-sm btn-primary addTableRows" title="Add more" onclick="addTableRowLM('localMachineryTable', 'localMachineryTableRow');">
...
<script>
    $(document).ready(function () {
        ...
        var form = $("#localMachineryForm"); //Get Form ID
    ...
    function addTableRowLM(tableID, template_row_id) {
        ...
        $("#" + tableID).find('#' + new_row_id).find('.local-machinery-action').attr('onchange', 'actionWiseFieldDisable(this, ["l_machinery_local_name' + final_total_row +'", "l_machinery_local_qty'+ final_total_row +'", "l_machinery_local_unit_price' + final_total_row + '", "l_machinery_local_total_value'+ final_total_row +'"], ["n_l_machinery_local_name' + final_total_row +'", "n_l_machinery_local_qty'+ final_total_row +'", "n_l_machinery_local_unit_price' + final_total_row + '", "n_l_machinery_local_total_value'+ final_total_row +'"])');
