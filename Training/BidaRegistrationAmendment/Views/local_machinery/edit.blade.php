{!! Form::open(array('url' => '/bida-registration-amendment/local-machinery-update','method' => 'post', 'class' => 'form-horizontal smart-form','id'=>'machineryForm',
...
<div class="modal-body">
    ...
    <div class="table-responsive">
        <table id="directorTable" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th class="bg-yellow" colspan="4">Existing information (Latest BIDA Reg. Info.)</th>
                <th class="bg-green" colspan="5">Proposed information</th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="light-yellow">
                    {!! Form::text('l_machinery_local_qty', $getlocalMachinery->l_machinery_local_qty, ['class' => 'form-control input-md', 'id' => 'l_machinery_local_qty']) !!}
                    {!! $errors->first('l_machinery_local_qty','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-yellow">
                    {!! Form::text('l_machinery_local_unit_price', $getlocalMachinery->l_machinery_local_unit_price, ['class' => 'form-control input-md', 'id' => 'l_machinery_local_unit_price']) !!}
                    {!! $errors->first('l_machinery_local_unit_price','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-yellow">
                    {!! Form::text('l_machinery_local_total_value', $getlocalMachinery->l_machinery_local_total_value, ['class' => 'form-control input-md', 'id' => 'l_machinery_local_total_value']) !!}
                ...
                <td class="light-green">
                    {!! Form::text('n_l_machinery_local_qty', $getlocalMachinery->n_l_machinery_local_qty, ['class' => 'form-control input-md', 'id' => 'n_l_machinery_local_qty']) !!}
                    {!! $errors->first('n_l_machinery_local_qty','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-green">
                    {!! Form::text('n_l_machinery_local_unit_price', $getlocalMachinery->n_l_machinery_local_unit_price, ['class' => 'form-control input-md', 'id' => 'n_l_machinery_local_unit_price']) !!}
                    {!! $errors->first('n_l_machinery_local_unit_price','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-green">
                    {!! Form::text('n_l_machinery_local_total_value', $getlocalMachinery->n_l_machinery_local_total_value, ['class' => 'form-control input-md', 'id' => 'n_l_machinery_local_total_value']) !!}
