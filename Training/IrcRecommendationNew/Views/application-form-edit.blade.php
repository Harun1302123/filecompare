                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            ...
                            {{--                                <a href="{{ asset('assets/images/SampleForm/irc_recommendation_new.pdf') }}" target="_blank" class="btn btn-warning">--}}
                                                ...
                                                <div id="ref_app_tracking_no_div"
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <a href="{{ CommonFunction::getUrlByTrackingNo($appInfo->ref_app_tracking_no) }}" target="_blank"><span
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group date" data-date-format="dd-mm-yyyy">
                                                            {!! Form::text('ref_app_approve_date', (empty($appInfo->ref_app_approve_date)) ? '' : date('d-M-Y', strtotime($appInfo->ref_app_approve_date)), ['class'=>'form-control input-md datepicker', 'id' => 'ref_app_approve_date', 'placeholder'=>'Pick from datepicker']) !!}
                                                        </div>
                                                    </div>
                                                    {{-- this section added by atik for date showing issue --}}
                                                </div>
