{!! Form::open(array('url' => '/irc-recommendation-new/update-annual-production','method' => 'post', 'class' => 'form-horizontal smart-form','id'=>'annualProductionForm',
    ...
    <div class="table-responsive">
        <table id="annualProductionTable" class="table table-striped table-bordered dt-responsive" cellspacing="0"
            ...
            <tr id="annualProductionTableRow">
                ...
                <td>
                    {!! Form::number("em_quantity[0]", $apcData->quantity , ['class' => 'form-control numberNoNegative input-md product required']) !!}
                </td>

                <td>
                    {!! Form::number("em_price_usd[0]", $apcData->price_usd, ['class' => 'form-control numberNoNegative input-md product required']) !!}
                </td>

                <td>
                    {!! Form::number("em_value_taka[0]", $apcData->price_taka, ['class' => 'form-control numberNoNegative input-md number required', 'id'=>'product_capacity_price_usd']) !!}
                </td>
            </tr>
            </tbody>
        </table>
