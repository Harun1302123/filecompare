...
<script language="javascript">
    ...
    //         window.opener.document.getElementById("IRCRecommendationNewForm").setAttribute("target", "_self");
    //         window.opener.jQuery("#IRCRecommendationNewForm").submit();
    //         window.close();
    //     });
    // });
    ...
    jQuery('#IRCRecommendationNewForm :input').attr('disabled', true);
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#IRCRecommendationNewForm-p-4").css({"display": "block"});
