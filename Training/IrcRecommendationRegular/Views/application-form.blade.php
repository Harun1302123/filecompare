                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if (Session::get('loadData.ex_machine_attachment'))
                                                                <a target="_blank" class="documentUrl btn btn-xs btn-primary" href="{{ url('uploads/'.Session::get('loadData.ex_machine_attachment')) }}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if (Session::get('loadData.import_attachment'))
                                                                <a target="_blank" class="documentUrl btn btn-xs btn-primary" href="{{ url('uploads/'.Session::get('loadData.import_attachment')) }}">
                                                                    <i class="fa fa-file-pdf" aria-hidden="true"></i>
                                                                    Open File
                                                                </a>
                                                            @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if (Session::get('loadData.production_attachment'))
                                                                <a target="_blank" class="documentUrl btn btn-xs btn-primary" href="{{ url('uploads/'.Session::get('loadData.production_attachment')) }}">
                                                                    <i class="fa fa-file-pdf" aria-hidden="true"></i>
                                                                    Open File
                                                                </a>
                                                            @endif
                                                                ...
                                                                <tr id="saleStatementTblRow{{$index}}" data-number="0" class="table-tr">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @if ($statement->sales_attachment)
                                                                            <a target="_blank" class="documentUrl btn btn-xs btn-primary" href="{{ url('uploads/'.$statement->sales_attachment) }}">
                                                                                <i class="fa fa-file-pdf" aria-hidden="true"></i>
                                                                                Open File
                                                                            </a>
                                                                        @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if (Session::get('loadData.export_attachment'))
                                                                <a target="_blank" class="documentUrl btn btn-xs btn-primary" href="{{ url('uploads/'.Session::get('loadData.export_attachment')) }}">
                                                                    <i class="fa fa-file-pdf" aria-hidden="true"></i>
                                                                    Open File
                                                                </a>
                                                            @endif
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group" style="margin-top: 2px">
                                                            <div class="col-md-6 {{$errors->has('n_first_em_lc_total_five_percent') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-9">
                                                                    {!! Form::number('n_first_em_lc_total_five_percent', '', ['class' => 'form-control input-md n_first_em_lc_total_five_percent required']) !!}
