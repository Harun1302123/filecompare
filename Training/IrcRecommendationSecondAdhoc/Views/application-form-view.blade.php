    ...
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="pull-left">
                    <strong style="line-height: 30px;">
                        Application for Import Registration Certificate Recommendation (IRC)
                    </strong>
                </div>
                <div class="pull-right" data-html2canvas-ignore="true">
                    @if(count($inspectionInfo) > 0)
                        @if((Auth::user()->user_type == '5x505' && in_array($appInfo->status_id,[25])) || in_array(Auth::user()->user_type, ['1x101','2x202', '4x404']))
                            ...
                            <a href="{{ url('irc-recommendation-second-adhoc/production-capacity-pdf/'.Encryption::encodeId($appInfo->id)) }}" class="btn btn-sm btn-primary" title="" target="_blank">Production Capacity</a>
                            @endif
                            {{--                            <a href="{{ url('irc-recommendation-second-adhoc/existing-machines-pdf/'.Encryption::encodeId($appInfo->id)) }}" class="btn btn-sm btn-primary" title="" target="_blank">Exisiting Machineries</a>--}}
                            @if(!empty($last_inspection_id) && $appInfo->irc_purpose_id != 2)
                                <a href="{{ url('irc-recommendation-second-adhoc/entitlement-paper-pdf/'.Encryption::encodeId($last_inspection_id)) }}" class="btn btn-sm btn-primary" title="" target="_blank">Entitlement Paper</a>
                            @endif
                        @endif
                    @endif

                    @if(count($inspectionInfo) > 0 && (in_array(Auth::user()->user_type, ['1x101','2x202', '4x404'])))
                        <a class="btn btn-sm btn-warning" data-toggle="collapse" href="#inspectionInfo" role="button"
            ...
            <div class="panel-body">
                ...
                @include('IrcRecommendationSecondAdhoc::prevous-applications')
                ...
                @include('IrcRecommendationSecondAdhoc::inspection-information')
            ...
            <!-- Inspection Submission Deadline Date -->
                            ...
                            <div class="col-md-12">
                                @if($appInfo->last_br == 'yes')
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-xs-6">
                                            <a href="{{$data['br_ref_app_url']}}" target="_blank">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-5 col-xs-6">
                                        <span class="v_label">
                                            Did you receive 1st Adhoc IRC recommendation through OSS?
                                        </span>
                                        <span class="pull-right">&#58;</span>
                                    </div>
                                    <div class="col-md-7 col-xs-6">
                                        {{ (!empty($appInfo->last_irc_1st_adhoc)) ? ucfirst($appInfo->last_irc_1st_adhoc) : ''  }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                @if($appInfo->last_irc_1st_adhoc == 'yes')
                                    <div class="row">
                                        <div class="col-md-5 col-xs-6">
                                        <span class="v_label">
                                            Please give your Approved IRC recommendation Tracking ID.
                                        </span>
                                            <span class="pull-right">&#58;</span>
                                        </div>
                                        <div class="col-md-7 col-xs-6">
                                            <a href="{{ $data['irc_ref_app_url'] }}" target="_blank">
                                ...
                                @if($appInfo->last_irc_1st_adhoc == 'no')
                                    <div class="row">
                                        <div class="col-md-5 col-xs-6">
                                        <span class="v_label">
                                            Please give your memo number of IRC Recommendation
                                        </span>
                                            <span class="pull-right">&#58;</span>
                                        </div>
                                        <div class="col-md-7 col-xs-6">
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-5 col-xs-6">
                                <span class="v_label">
                                    Please give your IRC Number (CCI&E)
                                </span>
                                    <span class="pull-right">&#58;</span>
                                </div>
                                <div class="col-md-7 col-xs-6">
                                    ...
                                    @if(!empty($appInfo->irc_ccie_brows_copy))
                                        <a target="_blank" class="documentUrl btn btn-xs btn-success" href="{{URL::to('/uploads/'.(!empty($appInfo->irc_ccie_brows_copy) ? $appInfo->irc_ccie_brows_copy : ''))}}">
                                    ...
                                    {{-- @if(empty($appInfo->irc_ccie_brows_copy))
                                        <span class="badge badge-warning">Certificate not found</span>
                                    @else
                                        <a href="{{URL::to('/uploads/'.(!empty($appInfo->irc_ccie_brows_copy) ? $appInfo->irc_ccie_brows_copy : ''))}}" target="_blank" class="btn btn-success btn-sm">View Certificate</a>
                                    @endif --}}
                    ...
                    <div class="panel-body">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="brProductionSpareTbl">
                                        <thead>
                                        <tr>
                                            <th>#</th>
                            ...
                            @if(in_array($appInfo->irc_purpose_id, [1,3]) && count($annualProductionCapacity) > 0)
                                <fieldset id="annual_raw">
                                    ...
                                    <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%" id="productionCostTbl">
                                        <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Name of Product</th>
                                        ...
                                        @foreach($annualProductionCapacity as $apc)
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="modal" data-target="#IRCModal" onclick="openModal(this)" data-action="{{ url('irc-recommendation-second-adhoc/get-raw-material/'.Encryption::encodeId($apc->apc_id)) }}" class="btn btn-xs btn-success"><i class="fa fa-folder-open"></i> Raw Material</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                            ...
                            @if($appInfo->purpose_id == 2 && count($annualProductionSpareParts) > 0)
                                <fieldset class="scheduler-border">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!empty($appInfo->ex_machine_attachment))
                                                <a target="_blank" class="documentUrl btn btn-xs btn-primary" href="{{URL::to('/uploads/'.(!empty($appInfo->ex_machine_attachment) ? $appInfo->ex_machine_attachment : ''))}}">
                                                    <i class="fa fa-file-pdf" aria-hidden="true"></i>
                                                    Open File
                                                </a>
                                            @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!empty($appInfo->import_attachment))
                                                <a target="_blank" class="documentUrl btn btn-xs btn-primary" href="{{URL::to('/uploads/'.(!empty($appInfo->import_attachment) ? $appInfo->import_attachment : ''))}}">
                                                    <i class="fa fa-file-pdf" aria-hidden="true"></i>
                                                    Open File
                                                </a>
                                            @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!empty($appInfo->production_attachment))
                                                <a target="_blank" class="documentUrl btn btn-xs btn-primary" href="{{URL::to('/uploads/'.(!empty($appInfo->production_attachment) ? $appInfo->production_attachment : ''))}}">
                                                    <i class="fa fa-file-pdf" aria-hidden="true"></i>
                                                    Open File
                                                </a>
                                            @endif
                                ...
                                <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="saleStatementTbl">
                                    ...
                                    @if(count($IRCSalesStatements) > 0)
                                        ...
                                        @foreach($IRCSalesStatements as $IRCSalesStatement)
                                            <tr>
                                                <td>{{ $inc++ }}</td>
                                                <td>{{ !empty($IRCSalesStatement->sales_statement_date) ? date('d-M-Y', strtotime($IRCSalesStatement->sales_statement_date)) : "" }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!empty($appInfo->export_attachment))
                                                <a target="_blank" class="documentUrl btn btn-xs btn-primary" href="{{URL::to('/uploads/'.(!empty($appInfo->export_attachment) ? $appInfo->export_attachment : ''))}}">
                                                    <i class="fa fa-file-pdf" aria-hidden="true"></i>
                                                    Open File
                                                </a>
                                            @endif
                        ...
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border">13. Import Capacity for six month (According to adhoc IRC)</legend>
                                        ...
                                        <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="insProductionRawTbl">
                                            ...
                                            @foreach($IrcSixMonthsImportRawMaterials as $value)
                                                <tr>
                                                    ...
                                                    <td>{{ $value->half_yearly_production }}</td>
                                                    <td>{{ $value->name }}</td>
                        ...
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border">15. Trade licence details</legend>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="col-md-5 col-xs-6">
                        ...
                        @if($appInfo->ownership_status_id != 3)
                            <fieldset class="scheduler-border">
                        ...
                        {{--23. Other Licenses/ NOC/ Permission/ Registration--}}
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border">23. Other Licenses/ NOC/ Permission/ Registration</legend>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-striped table-bordered" cellspacing="0"
                                            ...
                                            @if(count($otherLicence) > 0)
                                                ...
                                                @foreach($otherLicence as $otherLicence)
                                                    <tr>
                                                        <td>{{ $inc++ }}</td>
                                                        <td>{{ !empty($otherLicence->licence_name) ? $otherLicence->licence_name : '' }}</td>
                                                        <td>{{ !empty($otherLicence->licence_no) ? $otherLicence->licence_no : '' }}</td>
                                                        <td>{{ !empty($otherLicence->issuing_authority) ? $otherLicence->issuing_authority : '' }}</td>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7 col-xs-6">
                                                    @if(!empty($appInfo->g_signature))
                                                        <img src="{{ url('uploads/'.$appInfo->g_signature) }}" class="img-responsive">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
