                ...
                <div class="panel panel-info">
                    ...
                    <div class="form-body">
                        <div>
                            ...
                            {!! Form::hidden('reg_no', Session::get('loadData.reg_no') ,['class' => 'form-control input-md']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row hidden" id="br_ref_app_tracking_no_div">
                                                    <div class="{{$errors->has('br_ref_app_tracking_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-btn">
                                                                    @if(Session::get('last_br_check'))
                                                                        ...
                                                                        <a href="{{ !empty(Session::get('irc_certificate_link')) ? Session::get('irc_certificate_link') : '#' }}"
                                                            ...
                                                            <small class="text-danger">N.B.: Once you save or submit the
                                                                application, the BIDA Registration tracking no. cannot
                                                                be changed anymore.
                                                            </small>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group date" data-date-format="dd-mm-yyyy">
                                                            {!! Form::text('br_ref_app_approve_date', !empty(Session::get('br_ref_app_approve_date')) ? date('d-M-Y', strtotime(Session::get('br_ref_app_approve_date'))) : '', ['class'=>'form-control input-md datepicker', 'id' => 'br_ref_app_approve_date', 'placeholder'=>'Pick from datepicker']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="br_manually_approved_div" class="hidden {{$errors->has('br_manually_approved_no') ? 'has-error': ''}} ">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            {!! Form::text('br_manually_approved_no', '', ['data-rule-maxlength'=>'100', 'class' => 'form-control input-sm', 'onblur' => 'checkTrackingNoExists(this)']) !!}
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <div class="row hidden" id="irc_ref_app_tracking_no_div">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-btn">
                                                                    @if(Session::get('last_irc_check'))
                                                                        <button type="submit" class="btn btn-danger btn-sm" value="irc_clean_load_data"
                                                                                name="actionBtn" onclick="removeRequired()">Clear Loaded Data</button>
                                                                        <a href="{{ !empty(Session::get('irc_certificate_link')) ? Session::get('irc_certificate_link') : '#' }}" target="_blank"
                                                                           class="btn btn-success btn-sm">View Certificate</a>
                                                                    @else
                                                                        <button type="submit" class="btn btn-success btn-sm cancel" value="searchIRCinfo" name="actionBtn"
                                                                                id="searchIRCinfo">Load Information</button>
                                                                    @endif
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group date" data-date-format="dd-mm-yyyy">
                                                            {!! Form::text('irc_ref_app_approve_date', !empty(Session::get('irc_ref_app_approve_date')) ? date('d-M-Y', strtotime(Session::get('irc_ref_app_approve_date'))) : '', ['class'=>'form-control input-md datepicker', 'id' => 'irc_ref_app_approve_date', 'placeholder'=>'Pick from datepicker']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row" id="irc_ccie_no_div">
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('irc_ccie_brows_copy') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::file('irc_ccie_brows_copy', ['class' => 'required form-control input-md required', 'id' => 'irc_ccie_brows_copy_id', 'multiple' => true, 'accept' => 'application/pdf', 'onchange' => 'uploadDocumentProcess(this.id)']) !!}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <fieldset class="scheduler-border hidden"
                                                            ...
                                                            <legend class="scheduler-border">Other info. based on your business class (Code = <span
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 {{$errors->has('ceo_dob') ? 'has-error': ''}}">
                                                    ...
                                                    <div class=" col-md-7">
                                                        <div class="input-group date" data-date-format="dd-mm-yyyy">
                                                            {!! Form::text('ceo_dob',
                                                            (Session::get('loadData.ceo_dob') ? !empty((Session::get('loadData.ceo_dob')) ? date('d-M-Y', strtotime(Session::get('loadData.ceo_dob'))) : '') : (!empty($getCompanyData->ceo_dob) ? date('d-M-Y', strtotime($getCompanyData->ceo_dob)) : '')),
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group {{$errors->has('office_post_code') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('office_post_code', (Session::get('loadData.office_post_code') ? Session::get('loadData.office_post_code') : $getCompanyData->office_post_code), ['class' => 'form-control input-md alphaNumeric']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 {{$errors->has('factory_post_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('factory_post_code', (Session::get('loadData.factory_post_code') ? Session::get('loadData.factory_post_code') : $getCompanyData->factory_post_code), ['class' => 'form-control input-md number alphaNumeric']) !!}
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" cellspacing="0"
                                                    ...
                                                    <tbody id="manpower">
                                                    <tr>
                                                        <th class="alert alert-info" colspan="3">Local (Bangladesh only)
                                                        </th>
                                                        <th class="alert alert-info" colspan="3">Foreign (Abroad country)
                                                        </th>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 {{$errors->has('total_sales') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::number('total_sales', Session::get('loadData.total_sales'), ['class' => 'form-control input-md number', 'id'=>'total_sales']) !!}
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <br> --}}
                                            <fieldset class="scheduler-border">
                                                <legend class="scheduler-border">Annual Production Capacity as per BIDA registration
                                                </legend>
                                                <div class="table-responsive">
                                            ...
                                            <fieldset class="scheduler-border" id="annual_raw">
                                                ...
                                                <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%" id="productionRawTbl">
                                                    <thead>
                                                    <tr>
                                                        <th>Name of Product</th>
                                                        <th>Unit of Quantity</th>
                                                    ...
                                                    @if(count(Session::get('loadIRCAnnualProductionCapacity'))>0)
                                                        ...
                                                        @foreach(Session::get('loadIRCAnnualProductionCapacity') as $eachProductionCap)
                                                            {!! Form::hidden("apcId[$inc]", $eachProductionCap->id) !!}
                                                ...
                                                <table>
                                                    <tr>
                                                        <div class="text-center fz16 text-danger">
                                                            To add more than 5 raw materials. Please, click the
                                                            "Save as Draft" button and try again.
                                                        </div>
                                                    </tr>
                                                    <tr>
                                                        <div class="col-md-12">
                                            ...
                                            <fieldset class="scheduler-border" id="annual_spare"
                                                      style="display: none">
                                                <legend class="scheduler-border">Spare Parts Details</legend>
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered"
                                                           cellspacing="0" width="100%" id="productionSpareTbl">
                                                        <thead>
                                                        <tr>
                                        ...
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">8. Value of the Existing Machineries</legend>
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" cellspacing="0"
                                                       width="100%">
                                                    <thead class="alert alert-info">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            {!! Form::text('ex_machine_imported_value_bdt','',['class' => 'form-control input-md', 'id' => 'ex_machine_imported_value_bdt', 'onkeyup' => "calculateImportedAndLocalVaule()"]) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('ex_machine_local_value_bdt','',['class' => 'form-control input-md', 'id' => 'ex_machine_local_value_bdt', 'onkeyup' => "calculateImportedAndLocalVaule()"]) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('ex_machine_total_value_bdt','',['class' => 'form-control input-md', 'id' => 'ex_machine_total_value_bdt', 'readonly']) !!}
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                From {!! Form::text('import_duration_from_date', '', ['class'=>'form-control input-md datepicker', 'id' => 'irc_date', 'placeholder'=>'Pick from datepicker']) !!}</div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                To {!! Form::text('import_duration_to_date', '', ['class'=>'form-control input-md datepicker', 'id' => 'irc_date', 'placeholder'=>'Pick from datepicker']) !!}</div>
                                                        </td>
                                                        <td>
                                                            {!! Form::text('import_total_price_usd','',['class' => 'form-control input-md']) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('import_total_price_bdt','',['class' => 'form-control input-md']) !!}
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                From {!! Form::text('production_duration_from_date', '', ['class'=>'form-control input-md datepicker', 'id' => 'irc_date', 'placeholder'=>'Pick from datepicker']) !!}</div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                To {!! Form::text('production_duration_to_date', '', ['class'=>'form-control input-md datepicker', 'id' => 'irc_date', 'placeholder'=>'Pick from datepicker']) !!}</div>
                                                        </td>
                                                        <td>
                                                            {!! Form::text('production_total_quantity','',['class' => 'form-control input-md', 'id' => 'production_total_quantity', 'onkeyup' => "calculateProductionStock()"]) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('production_total_sales','',['class' => 'form-control input-md', 'id' => 'production_total_sales','onkeyup' => "calculateProductionStock()"]) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('production_total_stock','',['class' => 'form-control input-md', 'id' => 'production_total_stock', 'readonly']) !!}
                                                        </td>
                                                        <td>
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" cellspacing="0"
                                                    ...
                                                    <tbody>
                                                    <tr id="saleStatementTblRow0" data-number="0" class="table-tr">
                                                        <td>
                                                            {!! Form::text('sales_statement_date[0]', '', ['class'=>'form-control input-md monthpicker', 'id' => '', 'placeholder'=>'Pick from datepicker']) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('sales_value_bdt[0]','',['class' => 'form-control input-md sales_value_bdt', 'onkeyup' => "calculateAddRowTotal('sales_value_bdt', 'sales_value_bdt_total')"]) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('sales_vat_bdt[0]','',['class' => 'form-control input-md sales_vat_bdt', 'onkeyup' => "calculateAddRowTotal('sales_vat_bdt', 'sales_vat_total')"]) !!}
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-md btn-primary addTableRows"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{!! Form::text('sales_value_bdt_total','',['class' => 'form-control input-md', 'id'=>'sales_value_bdt_total', 'readonly']) !!}</td>
                                                        <td colspan="2">{!! Form::text('sales_vat_total','',['class' => 'form-control input-md', 'id'=>'sales_vat_total', 'readonly']) !!}</td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </fieldset>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                From {!! Form::text('export_duration_from_date', '', ['class'=>'form-control input-md datepicker', 'id' => '', 'placeholder'=>'Pick from datepicker']) !!}</div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                To {!! Form::text('export_duration_to_date', '', ['class'=>'form-control input-md datepicker', 'id' => '', 'placeholder'=>'Pick from datepicker']) !!}</div>
                                                        </td>
                                                        <td>
                                                            {!! Form::text('export_total_price_usd','',['class' => 'form-control input-md']) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('export_total_price_bdt','',['class' => 'form-control input-md']) !!}
                                                        </td>
                                                        <td>
                                        ...
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border required-star" >13. Import Capacity for six month (According to adhoc IRC)
                                            </legend>
                                            <fieldset class="scheduler-border" id="annual_ins_raw">
                                                    ...
                                                    <table class="table table-striped table-bordered" cellspacing="0"
                                                        ...
                                                        @if(count(Session::get('loadIRCInspectionAnnualProduction'))>0)
                                                            ...
                                                            @foreach(Session::get('loadIRCInspectionAnnualProduction') as $apc)
                                                                <tr id="rowProRawCostCount{{$count}}">
                                                                    <td>
                                                                        {!! Form::text("ins_apc_product_name[$count]",$apc->product_name,['class' => 'form-control input-md ins_apc_product_name', 'id'=>'ins_apc_product_name', 'readonly']) !!}
                                                                    </td>
                                                                    <td>
                                                                        {!! Form::text("ins_apc_yearly_production[$count]",$apc->fixed_production,['class' => 'form-control input-md ins_apc_yearly_production', 'id'=>'ins_apc_yearly_production', 'readonly']) !!}
                                                                    </td>
                                                                    <td>
                                                                        {!! Form::text("ins_apc_half_yearly_production[$count]",$apc->half_yearly_production,['class' => 'form-control input-md ins_apc_half_yearly_production', 'id'=>'ins_apc_half_yearly_production', 'readonly']) !!}
                                                                    </td>
                                                                    <td>
                                                                        {!! Form::select("ins_apc_quantity_unit[$count]",$productUnit,$apc->quantity_unit,['class'=>'form-control input-md ins_apc_quantity_unit', 'id' => 'ins_apc_quantity_unit', 'readonly']) !!}
                                                                    </td>
                                                                    <td>
                                                                        {!! Form::text("ins_apc_half_yearly_import[$count]",$apc->half_yearly_import,['class' => 'number form-control input-md ins_apc_half_yearly_import', 'id' => 'ins_apc_half_yearly_import', 'readonly']) !!}
                                                                    </td>
                                                                </tr>
                                                                <?php $count++ ?>
                                                            @endforeach
                                                        @else
                                                            <tr id="rowProRawCostCount0">
                                                                ...
                                                                <td>
                                                                    {!! Form::text('ins_apc_half_yearly_import[0]','',['class' => 'number form-control input-md ins_apc_half_yearly_import', 'onkeyup' => "calculateAddRowTotal('ins_apc_half_yearly_import', 'ins_apc_half_yearly_import_total')", 'id'=>'ins_apc_half_yearly_import']) !!}
                                                                </td>
                                                                <td>
                                                                    <a class="btn btn-md btn-primary addTableRows"
                                                                       onclick="addTableRowForIRC('insProductionRawTbl', 'rowProRawCostCount0');">
                                                                        <i class="fa fa-plus"></i></a>
                                                                </td>
                                                            </tr>
                                                        @endif
                                                ...
                                                <table class="table" width="100%">
                                                    <tr>
                                                        ...
                                                        <td>{!! Form::text('ins_apc_half_yearly_import_total',Session::get('loadIRCInspectionData.apc_half_yearly_import_total'),['class' => 'form-control input-md ins_apc_half_yearly_import_total', 'readonly', 'id'=>'ins_apc_half_yearly_import_total', !empty(Session::get('loadIRCInspectionData.apc_half_yearly_import_total')) ? "readonly" : ""]) !!}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-right">Total import capacity for raw materials (in words)</td>
                                                        <td colspan="2">{!! Form::text('ins_apc_half_yearly_import_total_in_word',Session::get('loadIRCInspectionData.apc_half_yearly_import_total_in_word'),['class' => 'form-control input-md ins_apc_half_yearly_import_total_in_word', 'id'=> 'ins_apc_half_yearly_import_total_in_word']) !!}</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group" style="margin-top: 2px">
                                                            <div class="col-md-6 {{$errors->has('first_em_lc_total_five_percent') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-9">
                                                                    {!! Form::number('first_em_lc_total_five_percent', Session::get('loadIRCInspectionData.em_lc_total_five_percent'), ['class' => 'form-control input-md required']) !!}
                                                            ...
                                                            <div class="col-md-6 form-group {{$errors->has('first_em_lc_total_five_percent_in_word') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-10">
                                                                    {!! Form::text('first_em_lc_total_five_percent_in_word', Session::get('loadIRCInspectionData.em_lc_total_five_percent_in_word'), ['class' => 'form-control input-md required']) !!}
                                                    ...
                                                    {{-- <div class="row">
                                                        <div class="form-group">
                                                            <div class="col-md-12 {{$errors->has('first_em_lc_total_taka_mil') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-5">
                                                                    {!! Form::text('first_em_lc_total_taka_mil', Session::get('loadIRCInspectionData.em_lc_total_taka_mil'), ['class' => 'form-control input-md required first_em_lc_total_taka_mil', 'id'=> 'first_em_lc_total_taka_mil']) !!}
                                                    ...
                                                    {{-- <div class="row"> --}}
                                                        {{-- <div class="form-group" style="margin-top: 2px"> --}}
                                                            {{-- <div class="col-md-3 {{$errors->has('first_em_lc_total_percent') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-5">
                                                                    {!! Form::text('first_em_lc_total_percent', Session::get('loadIRCInspectionData.em_lc_total_percent'), ['class' => 'form-control input-md required']) !!}
                                                            ...
                                                            {{-- <div class="col-md-3 {{$errors->has('first_em_lc_total_five_percent') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-10">
                                                                    {!! Form::text('first_em_lc_total_five_percent', Session::get('loadIRCInspectionData.em_lc_total_five_percent'), ['class' => 'form-control input-md required']) !!}
                                                                    {!! $errors->first('first_em_lc_total_five_percent','<span class="help-block">:message</span>') !!}
                                                                </div>
                                                            </div> --}}
                                            ...
                                            <fieldset class="scheduler-border" id="annual_ins_both" style="display: none">
                                                ...
                                                <table class="table" width="100%">
                                                    <tr>
                                                        ...
                                                        <td>{!! Form::number('import_cap_grd_total','',['class' => 'form-control input-md import_cap_grd_total', 'id'=>'import_cap_grd_total']) !!}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-right">Grand total (in words)</td>
                                                        <td colspan="2">{!! Form::text('import_cap_grd_total_wrd','',['class' => 'form-control input-md import_cap_grd_total_wrd','id'=>'import_cap_grd_total_wrd']) !!}</td>
                                                    </tr>
                                                </table>
                                            </fieldset>
                                        </fieldset>
                                        ...
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border"><span class="required-star">14. Public utility service</span>
                                            </legend>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-12">
                                        ...
                                        <fieldset class="scheduler-border" id="incorporation">
                                            <legend class="scheduler-border">16. Incorporation Certificate Details</legend>
                                            <div class="row">
                                                <div class="form-group">
                                        ...
                                        {{--12. TIN--}}
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">17. Tax Identification Number (TIN) Details</legend>
                                            <div class="row">
                                                <div class="form-group">
                                        ...
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">18. Fire License Information Details</legend>
                                        ...
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">19. Environment Clearance Certificate Details</legend>
                                        ...
                                        {{--15. Bank information --}}
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">20. Authorized Bank Information Details</legend>
                                        ...
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">21. Membership of the Chamber/ Association Information Details
                                            </legend>
                                            <div class="row">
                                                <div class="form-group">
                                        ...
                                        {{--17. BIN/ VAT --}}
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">22. Business Identification Number (BIN)/ Value-added Tex (VAT) Details</legend>
                                            <div class="row">
                                                <div class="form-group">
                                                ...
                                                <table id="otherLicenceTbl"
                                                    ...
                                                    @else
                                                        <tr id="otherLicence0" data-number="1" class="table-tr">
                                                            ...
                                                            <td>
                                                                <a class="btn btn-md btn-primary addTableRows"
                                                                   onclick="addTableRowForIRC('otherLicenceTbl', 'otherLicence0');">
                                                                   <i class="fa fa-plus"></i></a>
                                                            </td>
                                                        </tr>
                                                    @endif
                            ...
                            <fieldset>
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">Information of (Chairman/ Managing Director/ Or Equivalent):
                                            </legend>
                                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    information/ statement is given.
                                                </label>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function addTableRowForIRC(tableID, template_row_id) {
        ...
        if (final_total_row > 3) {
            ...
            // add colspan attr for For Raw Materials and section 14
            if (tableID === 'insProductionRawTbl') {
                $("#insProductionRawTbl").find('tfoot').find('td:eq(1)').attr('colspan', 2);
            }
        }
                    ...
                    if (last_irc == 'yes') {
                        ...
                        if (sessionLastIRC == 'yes') {
                            ...
                            if($('#irc_purpose_id').find(":selected").val() != loaded_irc_purpose_id){
                                alert('IRC purpose did not match with 1st adhoc. Please change.');
                                return false;
                            }
                            return true;
                        }
                        alert('Please, load IRC 1st adhoc data.');
                        return false;
                    }
                }
    ...
    function sectionChange(selectedvalue) {
        if (selectedvalue == 1) { // 1 = Raw material
            ...
            //annual_raw
            classAddRemove(['apc_product_name', 'apc_quantity_unit', 'apc_quantity', 'apc_price_usd', 'apc_value_taka', 'ins_apc_product_name', 'ins_apc_yearly_production', 'ins_apc_half_yearly_production', 'ins_apc_quantity_unit', 'ins_apc_half_yearly_import', 'ins_apc_half_yearly_import_total_in_word', 'ins_apc_half_yearly_import_total_in_word'], 'block');
