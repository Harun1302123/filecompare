                    ...
                    <div class="panel-heading">
                        ...
                        @if(in_array(Auth::user()->user_type, ['1x101','2x202', '4x404']))
                            <div class="pull-right">
                                <a href="{{ url('irc-recommendation-second-adhoc/report-generate/'.Encryption::encodeId($inspectionInfo->id)) }}" class="btn btn-sm btn-success" title="" target="_blank">Inspection report</a>
                            </div>
                        @endif
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="row">
                                        {{--Already have--}}
                                        @if(!empty($inspectionInfo->fl_number))
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    <div class="col-md-5">
