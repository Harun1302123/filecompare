    ...
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="pull-left">
                    <strong style="line-height: 30px;">
                        Application for Import Registration Certificate (IRC) recommendations 3rd Adhoc
                    </strong>
                </div>
                <div class="pull-right" data-html2canvas-ignore="true">
                    @if(count($inspectionInfo) > 0)
                        @if((Auth::user()->user_type == '5x505' && in_array($appInfo->status_id,[25])) || in_array(Auth::user()->user_type, ['1x101','2x202', '4x404']))
                            @if($appInfo->irc_purpose_id != 2)
                                <a href="{{ url('irc-recommendation-third-adhoc/production-capacity-pdf/'.Encryption::encodeId($appInfo->id)) }}" class="btn btn-sm btn-primary" title="" target="_blank">Production Capacity</a>
                            ...
                            @if(!empty($last_inspection_id) && $appInfo->irc_purpose_id != 2)
                                <a href="{{ url('irc-recommendation-third-adhoc/entitlement-paper-pdf/'.Encryption::encodeId($last_inspection_id)) }}" class="btn btn-sm btn-primary" title="" target="_blank">Entitlement Paper</a>
                            @endif
                        @endif
                    @endif
                    ...
                    @if (isset($appInfo) && $appInfo->status_id == 25 && isset($appInfo->certificate_link) && in_array(Auth::user()->user_type, ['1x101','2x202', '4x404', '5x505']))
                        <a href="{{ url($appInfo->certificate_link) }}" class="btn show-in-view btn-sm btn-info" title="Download Approval Copy" target="_blank">
            ...
            <div class="panel-body">
                ...
                @include('IrcRecommendationThirdAdhoc::prevous-applications')
                ...
                @include('IrcRecommendationThirdAdhoc::inspection-list')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-5 col-xs-6">
                                        <span class="v_label">
                                            Did you receive 2nd Adhoc IRC recommendation through OSS?
                                        </span>
                                        <span class="pull-right">&#58;</span>
                                    </div>
                                    <div class="col-md-7 col-xs-6">
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-5 col-xs-6">
                                <span class="v_label">
                                    Please give your IRC Number second adhoc  (CCI&E)
                                </span>
                                    <span class="pull-right">&#58;</span>
                                </div>
                                <div class="col-md-7 col-xs-6">
...
{{--                                        <legend class="scheduler-border">Raw Materials Details</legend>--}}
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="productionCostTbl">
                                                <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Name of Product</th>
                                                ...
                                                @foreach($annualProductionCapacity as $apc)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a data-toggle="modal" data-target="#IRCModal" onclick="openModal(this)" data-action="{{ url('irc-recommendation-third-adhoc/get-raw-material/'.Encryption::encodeId($apc->apc_id)) }}" class="btn btn-xs btn-success"><i class="fa fa-folder-open"></i> Raw Material</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                        ...
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border">14. Public utility service</legend>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
