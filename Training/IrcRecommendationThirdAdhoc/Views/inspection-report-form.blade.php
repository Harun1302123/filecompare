                    ...
                    <div class="panel-heading">
                        ...
                        @if(in_array(Auth::user()->user_type, ['1x101','2x202', '4x404']))
                            <div class="pull-right">
                                <a href="{{ url('irc-recommendation-third-adhoc/report-generate/'.Encryption::encodeId($inspectionInfo->id)) }}" class="btn btn-sm btn-success" title="" target="_blank">Inspection report</a>
                            </div>
                        @endif
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                @if($inspectionInfo->irc_purpose_id != 1 && count($annualProductionSpareParts) > 0)
                                    <table class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                        <thead class="alert alert-info">
                                        <tr>
                                            <th class="text-center">ক্রমিক নং</th>
                                        ...
                                        @foreach($annualProductionSpareParts as $apsp)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{ (!empty($apsp->quantity) ? $apsp->quantity : '') }}
                                                </td>
                                                <td>
                                ...
                                @if($inspectionInfo->irc_purpose_id != 2 && count($inspectionAnnualProductionCapacity) > 0)
                                    ...
                                    <table class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{-- <span>{{ ($inspectionInfo->apc_half_yearly_import_total ?? 0) + ($inspectionInfo->apc_half_yearly_import_other ?? 0) }}</span> --}}
                                                <span>
...
{{--                                    <span><strong>খুচরা যন্ত্রাংশের ষান্মাসিক আমদানিস্বত্ব/ চাহিদা</strong></span>--}}
{{--                                    <div class="form-group">--}}
{{--                                        <div class="row">--}}
{{--                                            <div class="col-md-12">--}}
