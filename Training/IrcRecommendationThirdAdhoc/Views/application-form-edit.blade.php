                                                    ...
                                                    <div class="{{$errors->has('irc_ref_app_tracking_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <a href="{{ CommonFunction::getUrlByTrackingNo($appInfo->irc_ref_app_tracking_no) }}" target="_blank"><span
                                                                            class="label label-success"
                                                                ...
                                                                <small class="text-danger">N.B.: Once you save or submit
                                                                    the
                                                                    application, the IRC 2nd adhoc tracking no cannot be
                                                                    changed anymore.
                                                                </small>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 {{$errors->has('total_sales') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::number('total_sales', $appInfo->total_sales, ['class' => 'form-control input-md number', 'id'=>'total_sales']) !!}
...
{{--                                                    <legend class="scheduler-border">Raw Materials Details</legend>--}}
                                            ...
                                            <fieldset class="scheduler-border" id="annual_raw">
                                                <legend class="scheduler-border">Recommended Annual Production
                                                    Capacity as per IRC.
                                                </legend>
...
{{--                                                    <legend class="scheduler-border">Raw Materials Details</legend>--}}
                                                    <div class="panel panel-info">
                                                        <div class="panel-heading">
                                                            ...
                                                            <div class="pull-right">
                                                                <a data-toggle="modal" data-target="#irc3rdadhocModal" onclick="openModal(this)"
                                                                data-action="{{ url('irc-recommendation-third-adhoc/apc-form/'.Encryption::encodeId($appInfo->id)) }}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(!empty($appInfo->ex_machine_attachment))
                                                                <a target="_blank"
                                                                   class="Url btn btn-xs btn-primary"
                                            ...
                                            <fieldset class="scheduler-border" id="annual_ins_raw">
                                                    ...
                                                    <table class="table table-striped table-bordered" cellspacing="0"
                                                        ...
                                                        @if(count($six_months_import_raw)>0)
                                                            ...
                                                            @foreach($six_months_import_raw as $apc)
                                                                <tr id="insProRawCostCount{{$count}}">
                                                                    ...
                                                                    <td>
                                                                        {!! Form::text("ins_apc_yearly_production[$count]",$apc->yearly_production,['class' => 'form-control input-md']) !!}
                                                                    </td>
                                                                    <td>
                                                                        {!! Form::text("ins_apc_half_yearly_production[$count]",$apc->half_yearly_production,['class' => 'form-control input-md']) !!}
                                                                    </td>
                                                                    <td>
                                                        ...
                                                        @else
                                                            <tr id="insProRawCostCount0">
                                                                ...
                                                                <td>
                                                                    {!! Form::text('ins_apc_half_yearly_import[0]','',['class' => 'number form-control input-md ins_apc_half_yearly_import',
                                                                    'onkeyup' => "calculateAddRowTotal('ins_apc_half_yearly_import', 'ins_apc_half_yearly_import_total')"]) !!}
                                                                </td>
                                                                <td>
                                                                    <a class="btn btn-md btn-primary addTableRows"
                                                ...
                                                <table class="table" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">{!! Form::text('ins_apc_half_yearly_import_total_in_word',$appInfo->ins_apc_half_yearly_import_total_in_word,['class' => 'form-control input-md']) !!}</td>
                                                    </tr>
                                                </table>
...
{{--                                                        <td>{!! Form::text('ins_apsp_half_yearly_import_total', $appInfo->ins_apsp_half_yearly_import_total, ['class' => 'form-control input-md ins_apsp_half_yearly_import_total', 'id' => 'ins_apsp_half_yearly_import_total']) !!}</td>--}}
{{--                                                    </tr>--}}
{{--                                                    <tr>--}}
{{--                                                        <td class="text-right">Total import capacity for spare parts (in words)</td>--}}
{{--                                                        <td colspan="2">{!! Form::text('ins_apsp_half_yearly_import_total_in_word',$appInfo->ins_apsp_half_yearly_import_total_in_word,['class' => 'form-control input-md ins_apsp_half_yearly_import_total_in_word']) !!}</td>--}}
{{--                                                    </tr>--}}
{{--                                                </table>--}}
{{--                                            </fieldset>--}}
                                                    ...
                                                    {{-- <div class="row">
                                                        <div class="form-group">
                                                            <div class="col-md-12 {{$errors->has('first_em_lc_total_taka_mil') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-5">
                                                                    {!! Form::text('first_em_lc_total_taka_mil', !empty($appInfo->first_em_lc_total_taka_mil) ? $appInfo->first_em_lc_total_taka_mil : "", ['class' => 'form-control input-md first_em_lc_total_taka_mil']) !!}
                                                    ...
                                                    {{-- <div class="row"> --}}
                                                        {{-- <div class="form-group" style="margin-top: 2px"> --}}
                                                            {{-- <div class="col-md-3 {{$errors->has('first_em_lc_total_percent') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-5">
                                                                    {!! Form::text('first_em_lc_total_percent', !empty($appInfo->first_em_lc_total_percent) ? $appInfo->first_em_lc_total_percent : "", ['class' => 'form-control input-md first_em_lc_total_percent']) !!}
                                                            ...
                                                            {{-- <div class="col-md-3 {{$errors->has('first_em_lc_total_five_percent') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-10">
                                                                    {!! Form::text('first_em_lc_total_five_percent', !empty($appInfo->first_em_lc_total_five_percent) ? $appInfo->first_em_lc_total_five_percent : "", ['class' => 'form-control input-md first_em_lc_total_five_percent']) !!}
                                                                    {!! $errors->first('first_em_lc_total_five_percent','<span class="help-block">:message</span>') !!}
                                                                </div>
                                                            </div> --}}
                                            ...
                                            <fieldset class="scheduler-border" id="annual_ins_both"
                                                      style="display: none">
                                        ...
                                        <div class="panel panel-info">
                                            <div class="panel-heading">
                                                ...
                                                <div class="pull-right">
                                                    ...
                                                    <a data-toggle="modal" data-target="#irc3rdadhocModal"
                                                        onclick="openModal(this)"
                                                        data-action="{{ url('/irc-recommendation-third-adhoc/create-director/'.Encryption::encodeId($appInfo->id)) }}">
...
{{--IRC 3rd Adhoc modal--}}
<div class="modal fade" id="irc3rdadhocModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        form.steps({
            ...
            onStepChanging: function (event, currentIndex, newIndex) {
                ...
                if (newIndex == 1) {
                    ...
                    if($('#irc_purpose_id').find(":selected").val() != app_irc_purpose_id && is_dataload_from_irc_2nd == 'yes'){
                ...
                if (newIndex == 2) {
                    ...
                    if (irc_purpose != 2) {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "<?php echo url(); ?>/irc-recommendation-third-adhoc/list-of-annual-production",
                            async: false,
                            data: {
                                _token: _token,
...
//            mp_ratio_foreign = Number((mp_ratio_foreign).toFixed(3));
    ...
    function LoadListOfDirectors() {
        $.ajax({
            url: "{{ url("irc-recommendation-third-adhoc/load-listof-directors") }}",
            type: "POST",
            data: {
    ...
    function loadAnnualProductionCapacityData() {
        $.ajax({
            url: "{{ url("irc-recommendation-third-adhoc/load-apc-data") }}",
            type: "POST",
            data: {
                app_id: "{{ Encryption::encodeId($appInfo->id) }}",
                _token : $('input[name="_token"]').val()
