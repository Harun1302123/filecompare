            ...
            <div class="box-body" id="inputForm">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        @if($appInfo->irc_purpose_id != 2 && count($annualProductionCapacity) > 0)
                            <div class="panel panel-info">
                                <div class="panel-heading">১২. এডহক ভিত্তিক কাঁচামালের ষান্মাসিক আমদানিস্বত্ব/ চাহিদা
                                </div>
                                <div class="panel-body">
                                    <table class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                        <thead class="alert alert-info">
                                            ...
                                            <tr>
                                                ...
                                                <td width="15%">
                                                    <table>
                                                        <tr>
                                                            <td>প্রতি&nbsp;</td>
                                                            <td>{!! Form::text("unit_of_product[]", $apc->unit_of_product, ['class' => 'form-control input-md', 'readonly']) !!}</td>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                <td width="15%">
