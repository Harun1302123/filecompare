<div class="ope_duration form-group">
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Decision</legend>

        <div class="form-group">
            <div class="row">
                <div class="col-md-12 {{$errors->has('approved_is_remittance_allowed') ? 'has-error': ''}}">
                    {!! Form::label('approved_is_remittance_allowed','Is outward remittance of any kind from Bangladesh sources will be allowed?',['class'=>'col-md-6 text-left required-star']) !!}
                    <div class="col-md-6">
                        <label class="radio-inline">{!! Form::radio('approved_is_remittance_allowed','yes', ($ope_info->is_remittance_allowed == 'yes' ? true :false), ['class'=>'cusReadonly helpTextRadio','id' => 'yes']) !!}
                            Yes
                        </label>
                        <label class="radio-inline">{!! Form::radio('approved_is_remittance_allowed', 'no', ($ope_info->is_remittance_allowed == 'no' ? true :false), ['class'=>'cusReadonly', 'id' => 'no']) !!}
                            No
                        </label>
        ...
        <div class="row">
            <div class="col-md-12">
                <h5 style="padding-left: 10px;"><strong>Office Permission Duration:</strong></h5>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <div class="col-md-3 {{$errors->has('approved_duration_start_date') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-12">
                        <div class="input-group date start_date_div">
                            {!! Form::text('approved_duration_start_date', (!empty($ope_info->approved_duration_start_date) ? date('d-M-Y', strtotime($ope_info->approved_duration_start_date)) : ''), ['class' => 'form-control input-md unsecure_datepicker', 'placeholder'=>'dd-mm-yyyy', 'id' => 'start_date']) !!}
                ...
                <div class="col-md-3 {{$errors->has('approved_duration_end_date') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-12">
                        <div class="input-group date end_date_div">
                            {!! Form::text('approved_duration_end_date', (!empty($ope_info->approved_duration_end_date) ? date('d-M-Y', strtotime($ope_info->approved_duration_end_date)) : ''), ['class' => 'form-control input-md unsecure_datepicker', 'placeholder'=>'dd-mm-yyyy', 'id' => 'end_date']) !!}
                            <span class="input-group-addon"
                ...
                <div class="col-md-3 {{$errors->has('approved_desired_duration') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-12">
                        {!! Form::text('approved_desired_duration', $ope_info->approved_desired_duration, ['class' => 'form-control input-md']) !!}
                ...
                <div class="col-md-3 {{$errors->has('approved_duration_amount') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-12">
                        {!! Form::text('approved_duration_amount', $ope_info->approved_duration_amount, ['class' => 'form-control input-md']) !!}
