            ...
            <div class="box-body" id="inputForm">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::hidden('app_type', 2,['class' => 'form-control input-md ', 'id'=>'']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('date_of_registration') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-8">
                                                <div class="datepicker input-group date" data-date-format="dd-mm-yyyy">
                                                    {!! Form::text('date_of_registration', $appInfo->date_of_registration, ['class'=>'form-control input-md', 'id' => 'date_of_registration', 'placeholder'=>'Pick from datepicker']) !!}
                                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-md-6 {{$errors->has('em_local_total_taka_mil') ? 'has-error': ''}}">
                                            {!! Form::label('em_local_total_taka_mil','স্থানীয় ভাবে সংগৃহীত (টাকা)',['class'=>'text-left col-md-5']) !!}
                                            <div class="col-md-7">
                                        ...
                                        <div class="col-md-6 form-group {{$errors->has('em_lc_total_taka_mil') ? 'has-error': ''}}">
                                            {!! Form::label('em_lc_total_taka_mil','এলসিকৃত (টাকা)',['class'=>'col-md-5 text-left ']) !!}
                                            <div class="col-md-7">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                {{-- @if($appInfo->irc_purpose_id != 2 && count($annualProductionCapacity) > 0) --}}
                                ...
                                {{-- @if($appInfo->irc_purpose_id != 1 && count($annualProductionSpareParts) > 0) --}}
                                @if($appInfo->irc_purpose_id == 2 && count($annualProductionSpareParts) > 0)  {{-- 2 = Spare parts --}}
                                <table class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                    <thead class="alert alert-info">
                                    <tr>
                                        <th class="text-center">ক্রমিক নং</th>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                        ...
                                        @foreach($ircSixMonthsImportRawMaterials as $value)
                                            <tr>
                                                <td><?php echo $count++ ?></td>
                                                <td>{!! Form::text("product_name[]", $value->product_name, ['class' => 'form-control input-md', 'readonly']) !!}</td>
                                                <td>{!! Form::number("fixed_production[]", $value->yearly_production, ['class' => 'form-control input-md required', 'onkeyup' => "calculateHalfYearlyProduction(this)"]) !!}</td>
                                                <td>{!! Form::number("half_yearly_production[]", $value->half_yearly_production, ['class' => 'form-control input-md required', 'readonly']) !!}</td>
                                                <td>{!! Form::number("half_yearly_import[]", $value->half_yearly_import, ['class' => 'form-control input-md apc_half_yearly_import required', 'onkeyup' => "calculateHalfYearlyImportTotal('apc_half_yearly_import', 'apc_half_yearly_import_total')"]) !!}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                        <tfoot>
                                        <tr>
                                            ...
                                            <td>{!! Form::number("apc_half_yearly_import_total", $appInfo->apc_half_yearly_import_total, ['class' => 'form-control input-md', 'id' => 'apc_half_yearly_import_total', 'readonly']) !!}</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12 {{$errors->has('apc_half_yearly_import_total_in_word') ? 'has-error': ''}}">
                                                {!! Form::label('apc_half_yearly_import_total_in_word','কথায়',['class'=>'text-left col-md-2']) !!}
                                                <div class="col-md-10">
                                                    {!! Form::text('apc_half_yearly_import_total_in_word', $appInfo->apc_half_yearly_import_total_in_word, ['class' => 'form-control input-md required']) !!}
                                    ...
                                    <div class="row">
                                        <div class="form-group" style="margin-top: 2px">
                                            {{-- <div class="col-md-2 {{$errors->has('em_lc_total_percent') ? 'has-error': ''}}">
                                                {!! Form::text('em_lc_total_percent', $appInfo->em_lc_total_percent, ['class' => 'form-control input-md required']) !!}
                                            ...
                                            <div class="col-md-4 {{$errors->has('em_lc_total_five_percent') ? 'has-error': ''}}">
                                                {!! Form::label('em_lc_total_five_percent','% হারে অর্থাৎ',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::number('em_lc_total_five_percent', $appInfo->em_lc_total_five_percent, ['class' => 'form-control input-md required']) !!}
                                            ...
                                            <div class="col-md-6 form-group {{$errors->has('em_lc_total_five_percent_in_word') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-10">
                                                    {!! Form::text('em_lc_total_five_percent_in_word', $appInfo->em_lc_total_five_percent_in_word, ['class' => 'form-control input-md required']) !!}
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                {{--                                <span>শিল্প খাত : <b>{{$appInfo->class_code . ' - ' . $busness_code[0]['section_name'] . ', ' . $sub_class->name}}</b></span>--}}
                                {{--                                <br>--}}
                                {{--                                <br>--}}
                                <table class="table table-bordered table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%"><textarea class="form-control maxTextCountDown valid" name="entitlement_remarks"></textarea></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
...
// End of code from bida old -------------
    ...
    function calculateHalfYearlyImportTotal(className, totalShowFieldId) {
        var total_import = 0.00;
        $("." + className).each(function () {
            total_import = total_import + (this.value ? parseFloat(this.value) : 0.00);
        });
        $("#" + totalShowFieldId).val(total_import.toFixed(3));
    }
